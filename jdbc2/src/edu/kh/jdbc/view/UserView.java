...
public class UserView {
	...
	private void insertUser() throws Exception {
		...
		// 서비스 호출(INSERT) 후 결과(삽입된 행의 개수, int)  반환 받기
	...
	private void selectUser() throws Exception {
		...
		// == 일치하는 사용자다 있다면 1행만 조회된다
		//  -> 1행의 조회 결과를 담기 위해 사용되는 객체 == User DTO
	...
	private void updateName() throws Exception {
		...
		// -> USER_NO 조회
		int userNo = service.updateName(userId, userPw);
	...
	private void insertUser2() throws Exception {
		...
		while(true) {
			...
			System.out.println("이미 사용중인 아이디 입니다. 다시 입력해 주세요");
		}
